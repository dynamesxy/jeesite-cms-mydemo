...
@Table(name = "${_prefix}cms_category", alias = "a", columns = {
		...
		@Column(name = "index_image", attrName = "indexImage", label = "首页栏目图片"),
		@Column(name = "category_en_name", attrName = "categoryEnName", label = "栏目英文名"),
...
public class Category extends TreeEntity<Category> {
	...
	private String indexImage;  //首页栏目图片
	private String categoryEnName; //栏目英文名

	private String parentCodeW; //父级编码
	...
	public String getParentCodeW() {
		return parentCodeW;
	}

	public void setParentCodeW(String parentCodeW) {
		this.parentCodeW = parentCodeW;
	}
}