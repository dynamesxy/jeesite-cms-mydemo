...
@Table(name = "${_prefix}cms_site", alias = "a", columns = {
		...
		@Column(name = "site_en_name", attrName = "siteEnName", label = "站点英文名称", queryType = QueryType.LIKE),
		...
		@Column(name = "copyrightEn", attrName = "copyrightEn", label = "英文版权信息"),
...
public class Site extends DataEntity<Site> {
	...
	private String siteEnName; //站点英文名称
	private String copyrightEn; //英文版权信息
